defmodule KandisOrderUiWeb do
  ...
  This can be used in your application as:
      ...
      use KandisOrderUiWeb, :controller
      use KandisOrderUiWeb, :view
  ...
  defp view_helpers do
    quote do
      ...
      import KandisOrderUi.ErrorHelpers
      # import MyAppBe.Gettext
      # alias MyAppWeb.Router.Helpers, as: Routes
      import MavuForm.InputHelpers
      import KandisOrderUi.BackendHelpers
