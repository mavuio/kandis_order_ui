defmodule KandisOrderUi.BackendHelpers do
  use Phoenix.HTML
  ...
  def format_price(price, config, params \\ []) when is_map(config) do
    KandisOrderUi.get_conf_val(config, :format_price_func).(price, params[:precision] || 2)
  end
end
